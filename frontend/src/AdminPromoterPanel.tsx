...
const siteFilterOptions = [
  ...
  { value: 'linkedin', label: 'linkedin.com' },
  { value: 'producthunt', label: 'producthunt.com' },
];

export default function AdminPromoterPanel() {
  ...
  useEffect(() => {
    ...
    if (githubAuth === 'success') {
      setMessage(`GitHub connected as ${githubLogin || 'connected'}.`);
    } else {
      setMessage(githubMessage || 'GitHub authentication failed.');
    }
